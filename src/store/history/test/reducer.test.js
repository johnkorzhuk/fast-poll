...
describe('history reducer', () => {
  ...
  it('should handle a addPollsAction action creator as expected', () => {
    ...
    expect(reducer(undefined, actions.addPollsAction('votedOn', [voted])).votedOn).toEqual([voted])
    expect(reducer(undefined, actions.addPollsAction('created', [created])).created).toEqual([created])
  })
